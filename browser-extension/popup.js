...
async function refresh() {
    ...
    document.getElementById('state').textContent = !state.connected ? 'Open Anjadhe and choose Browser setup, then Connect.'
        : state.control === 'agent' ? 'Connected. The agent is working.' : 'Connected. You are in control. Return to Anjadhe and Continue when ready.';
}
