...
public enum Route: Hashable {
    ...
    // Portfolio and News are apps with pages of their own (2026-09-21).
    ...
    case newsArticle(String)             // the article's url
    case newsTopics
    case newsSaved
}

public enum RootTab: String, CaseIterable { case home, assistant, apps, search }
