...
const goals = {
    ...
    trip: { id: id('goal'), title: 'Plan the December family trip', description: 'Ten days, somewhere warm. Flights, hotel, and one big surprise for Owen.', targetDate: ymd(130), status: 'in-progress', profile: 'default', ...stamp },
