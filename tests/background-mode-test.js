...
const trayPaths = [];
const manager = new BackgroundMode({ app, ipcMain: ipc, Tray, Menu: { buildFromTemplate: items => items }, nativeImage: { createFromPath: (p) => { trayPaths.push(p); return { setTemplateImage() {} }; } }, store, platform: 'darwin', isolated: false, openWindow: makeWindow });
