...
module.exports = [
  ...
  },
  {
    ...
    async run({ page }) {
      return await page.evaluate(() => {
        const expected = ['agent','actions','goals','calendar','email','fyi','notes','journal','prompts','bookmarks','news','reader','wellness','portfolio','browse','pomodoro','settings','aiactivity','help','about'];
