...
async function main() {
  ...
  // A run that was interrupted never reached the cleanup at the end, and
  // its leftovers (documents a later journey tagged Home/…) failed the next
  // run's docs-tags-are-paths at its "gone" check (2026-09-10). Start clean.
