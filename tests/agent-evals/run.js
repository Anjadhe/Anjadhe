...
async function main() {
  ...
  // A run that was interrupted never reached the cleanup at the end; start
  // clean so its leftovers cannot colour the next run. (The 2026-09-10
  // "gone" failure in docs-tags-are-paths was blamed on such leftovers; the
  // real cause was DocTags.forget stamping its tombstone behind the
  // record's updatedAt, fixed 2026-09-11.)
