 ...
 * mark for nenva, "You" for the user — and a kind tag when the update
 ...
 *     opts.checkIn     prompt string — renders "Ask nenva to check in"
    ...
    _rowHtml(u) {
        ...
        return `<div class="updates-row${ai ? ' is-ai' : ''}${kind ? ` is-${kind}` : ''}" data-update-id="${this._esc(u.id)}">
            ...
            <div class="updates-content">
                <span class="updates-who">${ai ? '<span class="updates-mark" aria-hidden="true"></span>nenva' : 'You'}${kind ? `<span class="updates-kind">${this._esc(kind)}</span>` : ''}</span>
        ...
        return `<div class="updates-section${opts.compact ? ' is-compact' : ''}" data-updates-key="${this._esc(key)}">
            ...
            <div class="updates-composer">
                ...
                <div class="updates-composer-foot">
                    ...
                    ${canAsk ? `<button type="button" class="updates-checkin-btn quiet-link-btn">Ask nenva to check in</button>` : ''}
                </div>
            </div>
