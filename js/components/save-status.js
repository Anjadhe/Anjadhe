...
const SaveStatus = {
     ...
     * answer on the page.
     */
    mark(elOrId, state, reason = '', { quiet = false, text: override = '' } = {}) {
        ...
        // text: an editor whose "saved" means something narrower (a draft
        // kept, not the record written) says so in its own words.
        let text = override || this.LABELS[state];
