...
const TaskListUI = {
    ...
    renderSection(tasks, opts = {}) {
        ...
        const actions = [
            opts.aiBreakdown ? `<button type="button" class="secondary-btn task-list-ai-btn" title="Ask the assistant to break this project into tasks">&#10022; Suggest tasks</button>` : '',
