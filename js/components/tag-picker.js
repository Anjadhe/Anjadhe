 ...
 *       initial: 'Finance/',   // optional — pre-filled search text (the
 *                              // Documents app seeds the selected tag's path
...
const TagPicker = {
    ...
    open(config) {
        ...
        render(initial);
        setTimeout(() => { search.focus(); search.setSelectionRange(initial.length, initial.length); }, 0);
