 ...
 * Optional `steps` / `budgetMs` override the loop's limits (10 steps and 2
 * minutes, or 40 and 8 for the browser) for a job that genuinely needs more.
 *
...
// Research: every claim is a search plus a page read, so ten steps cut
// multi-part questions short (2026-09-22).
Specialists.register({ id: 'research', label: 'Research', needs: {}, steps: 18, budgetMs: 5 * 60000,
