...
const AgentTools = {
    ...
    definitions: [
        ...
        { type: 'function', function: {
            ...
            description: 'List the user\'s background/scheduled prompts (the Prompts page; their runs post to the Home feed): id, title, prompt text, schedule (interval + time), last run. Call this FIRST for any question about a recurring prompt\'s schedule, timing, or behavior — e.g. "why did my market review run at the wrong time".',
            parameters: { type: 'object', properties: {} }
        }},
        { type: 'function', function: {
