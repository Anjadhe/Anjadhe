    ...
    updateModelChip() {
        ...
        const paint = (el) => {
            ...
            if (entry) {
                ...
                // (Anjadhe Cloud's model id IS the product name, so the pair
                // reads as a stutter: "anjadhe-cloud · anjadhe cloud").
                el.textContent = entry.engine === 'anjadhe'
                    ? this._engineLabel(entry.engine)
                    : `${entry.model} · ${this._engineLabel(entry.engine)}`;
    ...
    async _toggleModelMenu(chipEl) {
        ...
        for (const entry of entries) {
            ...
            name.textContent = entry.engine === 'anjadhe'
                ? this._engineLabel(entry.engine) : entry.model;
