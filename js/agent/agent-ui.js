...
const AgentUI = {
    ...
    confirmToolCall(toolName, args, summary, convId) {
        if (!this._agentSurfaceVisible()) {
            return this._confirmToolCallModal(toolName, args, summary, convId);
        }
        return new Promise((resolve) => {
            const ask = { toolName, args, summary, convId, resolve, settled: false };
    ...
    _confirmToolCallModal(toolName, args, summary, convId) {
        return new Promise((resolve) => {
            let settled = false;
            let instance = null;
