...
const AgentUI = {
    ...
    _paintEmptyHero(hero) {
        if (this.mode === 'app'
            ...
            hero.innerHTML =
                `<h2 class="agent-empty-hero-title">Hi &#8212; I&rsquo;m ${customName ? UIUtils.escapeHtml(customName) + ', ' : ''}your assistant.</h2>
                 <div class="agent-empty-greeting">
                     <p>I live on this Mac and work across everything in Anjadhe. A few things I can do:</p>
                     <ul>
                         <li><strong>Answer and research</strong> &#8212; questions, advice, and (with web search on) current events and prices.</li>
                         <li><strong>Turn email into action</strong> &#8212; connect Google and important mail becomes tasks with reminders.</li>
                         <li><strong>Plan your day</strong> &#8212; tasks, projects, calendar, and notes, together in one place I can see.</li>
                         <li><strong>Capture things</strong> &#8212; notes, journal entries, and drafts written in your own voice.</li>
                     </ul>
                     <p>Ask me anything below &#8212; or try &ldquo;What can you do?&rdquo; for the full tour.
                     Finish setting up anytime in <a href="#" class="agent-empty-greeting-where">Settings &rsaquo; Setup Assistant</a>.</p>
                 </div>`;
