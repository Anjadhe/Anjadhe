...
const AgentUI = {
                ...
                `<h2 class="agent-empty-hero-title">Hi &#8212; I&rsquo;m ${customName ? UIUtils.escapeHtml(customName) + ', ' : ''}your assistant.</h2>
                 <div class="agent-empty-greeting">
                     ...
                     <ul>
                         ...
                         <li><strong>Plan your day</strong> &#8212; tasks, goals, calendar, and notes, together in one place I can see.</li>
    ...
    _recordTypeLabel(recordKey) {
        ...
        const map = {
            goals: 'Goal', schedule: 'Task', notes: 'Note', prompts: 'Routine',
    ...
    GENERAL_SUGGESTIONS: [
        ...
        { text: 'How are my goals coming along?',
          when: () => ((StorageManager.get('goals')?.goals) || []).length > 0 },
        { text: 'Help me set a new goal', when: () => true },
    ...
    _openableFromResult(toolName, result) {
        ...
        switch (toolName) {
            ...
            case 'create_goal':
            case 'update_goal':
            case 'save_goal': return openRec('goals', result.goal?.id, 'Open goal');
    ...
    _describeToolAction(toolName, args) {
        ...
        switch (toolName) {
            ...
            case 'delete_goal': {
                ...
                return `Delete the goal <strong>${a(goal?.title || args.search || args.id || 'Unknown')}</strong>` +
