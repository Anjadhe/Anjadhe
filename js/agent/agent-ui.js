...
const AgentUI = {
    ...
    init() {
        ...
        // Anjadhe Cloud labels re-sync from the server catalog afterwards
    ...
    async refreshReadiness() {
        ...
        try {
            ...
            const CLOUD = { openai: 'OpenAI', anthropic: 'Anthropic', anjadhe: 'Anjadhe Cloud' };
    ...
    _paintEmptyHero(hero) {
        if (this.mode === 'app'
            ...
            // says what Anjadhe can do — a greeting in the chat, not a
            ...
            hero.innerHTML =
                `<h2 class="agent-empty-hero-title">Hi &#8212; I&rsquo;m ${customName ? esc(customName) + ', ' : ''}your assistant.</h2>
                 <p class="agent-empty-lede">I live on this Mac and work across everything in Anjadhe.</p>
    ...
    updateModelChip() {
        ...
        const paint = (el) => {
            ...
            if (entry) {
                ...
                // (an Anjadhe Cloud entry labeled "Anjadhe Cloud" would read
                // as a stutter; one labeled "Anjadhe Cloud Max" carries real
    ...
    async checkEngineStatus() {
        // A remote default brain (Anjadhe Cloud / OpenAI / Anthropic / user
    ...
    onTaskUpdate(task) {
        ...
        card.innerHTML = `
            <div class="agent-task-head">
                <span class="agent-task-eyebrow">${simple ? 'Anjadhe' : 'Task'} &middot; ${TITLE[task.status] || esc(task.status)}</span>
            ...
            btn.onclick = () => {
                ...
                if (act === 'approve') TaskService.approve(task.id);
                    ...
                    (async () => {
                        ...
                        if (anyExternal) msg += ' Actions outside Anjadhe (email, calendar, other apps) cannot be taken back and will remain.';
    ...
    _nudgeIfUnanswered(ask) {
        setTimeout(() => {
            ...
            Notify.show('Waiting for your answer',
                what + '\n\nAnswer it in Anjadhe, or on your phone.',
                { kind: 'approval' });
