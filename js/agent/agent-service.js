...
const AgentService = {
    ...
    UNTRUSTED_BLOCKED_TOOLS: new Set([
        ...
        // Library reads (search_library / read_library_doc / draft_in_style)
        // are blocked like memory reads (V4) — registered with
        // blockUntrusted by the Reader package (js/apps/reader/library-tools.js).
