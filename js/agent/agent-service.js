    ...
    async sendMessage(userMessage, onChunk, opts = {}) {
        ...
        try {
            ...
            while (iterations < this.maxToolIterations) {
                ...
                lastResponse = { type: 'text', content, thinking: thinking || undefined, sources: srcs || undefined, records: recs || undefined, actions: acts || undefined, undoScope: undoScope || undefined, model: response.model || activeModel };
                break;
            }
