...
Every feature page has a small **?** in its header that opens that page's guide in place.`
        ...
        'your-day': {
            ...
            content: `**Tasks** is what to do now — it opens to Today. **Insights** (its own app) is everything the assistant found in the user's mail and texts. Planning lives one door away: the **Plan** button on the Tasks page opens **Projects** — every active project in one table with its progress, next step, last update and target, each broken into tasks, each with an Updates log the user and the assistant both post to. (Projects — formerly Goals — was a third tab until 2026-08-03; planning is a different altitude from doing, so it is a door rather than a peer.)
