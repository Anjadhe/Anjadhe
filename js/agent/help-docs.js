...
The × on any story means show fewer like this — ranking learns from it, and hidden stories can be restored from the Topics dialog. Stories boosted toward your interests carry a "For you" label with the reason. Clicks, hides, and ranking all stay on this Mac; the model never chooses or writes the headlines you see.`
        ...
        'connected-accounts': {
            title: 'Connected accounts — Email, Calendar, Apple apps & Telegram',
            description: 'Connecting Gmail and Google Calendar, email bundles/insights/action items, the calendar lens, importing Apple Reminders, Notes and Calendar, and chatting with the assistant from Telegram.',
...
A separate switch forwards this Mac's notifications — reminders and alerts — to the linked chat. Disconnecting removes the token and the linked chat from this Mac.`
        },
