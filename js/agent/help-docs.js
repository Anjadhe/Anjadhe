...
Every feature page has a small **?** in its header that opens that page's guide in place.`
        ...
        'your-day': {
            ...
            description: 'The Actions app: Today list, quick-add in plain language, repeating tasks, overdue, weekly review, and the Goals page (groups, goals, the goal interview).',
            content: `Actions has two tabs. **Tasks** is what to do now — it opens to Today. **Goals** is where you plan — goals grouped by the part of life they belong to, each broken into tasks.
...
Once saved, the plan is measured against your real holdings: on the Plan page, whenever you ask the assistant, and in the home widget. Adding a transaction that puts you off plan says so at the time, and the Market Close Review (below) names any drift in the evening.
