/**
 * Screen tools — the assistant SEES nenva's own window and OPERATES it
 ...
 *       Email AI): there every action asks, grants or not
...
const ScreenTools = {
    ...
    async look(ctx = {}) {
        ...
        if (!window.electronScreen) return { error: 'Screen tools need the nenva desktop app.' };
