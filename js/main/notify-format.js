 ...
 *
 * The header is the KIND alone. It used to read "nenva · Reminder", and
 ...
 * approval (the assistant is waiting on a yes or no — 2026-09-21).
 * Anything else reads "Notification".
 */
const NOTIFY_KINDS = { reminder: 'Reminder', task: 'Task', routine: 'Routine', email: 'Email', message: 'Message', approval: 'Waiting on you' };
const BODY_MAX = 700;
