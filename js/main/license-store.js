 ...
 * `updatesUntil` is a date or null (= forever, the alpha class). nenva
...
const LicenseStore = {
     ...
     *  price is copy only and defaults to null = quote no number (2026-09-02: no future price is
     *  stated in app or site copy until a checkout exists). */
    policy() {
        let p = {};
        ...
        return { alphaClosesAt, trialDays, price: typeof p.price === 'string' && p.price.trim() ? p.price : null };
    },
