 ...
 * the top-right corner (the "Set up more of nenva" strip's shape, at
...
const UpdaterUI = {
    ...
    _showDownloading(info) {
        ...
        el.querySelector('.updater-strip-text').textContent = `Downloading nenva${v}`;
    ...
    _showDownloadFailed(info) {
        ...
        el.querySelector('.updater-strip-text').textContent = `Could not download nenva${v}. nenva will try again later.`;
