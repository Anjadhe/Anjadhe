    ...
    RELEASES: [
        ...
        },
        {
            ...
            highlights: [
                ...
                { title: 'Ctrl+Tab and an app switcher', body: 'Ctrl+Tab bounces between recent apps like browser tabs, and the grid button beside the wordmark lists every app. Settings is flatter too, and Cmd+K jumps straight to a specific setting.' },
