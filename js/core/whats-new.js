...
const WhatsNew = {
    ...
    CHANGELOG_PAGE: 'https://github.com/Anjadhe/Anjadhe/releases',
    FOUNDER_MAILTO: 'mailto:founder@anjadhe.ai?subject=nenva%20feedback',
    // The founder page on the site: the same address plus who he is and the
    // other ways to reach him. Settings › Send Feedback sends people here
    // rather than firing a mail client at them (2026-09-17, by request) —
    // a blank compose window is a worse door than a page that answers
    // "who am I writing to?" first. BOTH What's new windows send people here
    // too (2026-09-21, by request): someone reading release notes is browsing,
    // not composing, and a mailto that opens nothing on a Mac with no mail
    // client set up looks like a dead link. The mailto stays where the ask is
    // already specific: About and the license card.
    FOUNDER_PAGE: 'https://anjadhe.ai/founder',
    ...
    RELEASES: [
        {
            ...
            highlights: [
                { title: 'Reach from anywhere reads Tailscale again', body: 'Settings, Paired Devices showed \u201ccould not read the Tailscale status\u201d with the Tailscale app installed. It now shows whether Tailscale is running and whether Funnel is on.' }
            ]
        },
        {
            ...
            date: 'September 25, 2026',
            highlights: [
                { title: 'One conversation list everywhere', body: 'Your chats now sync one by one between your Macs and your phone, so a chat continued on two devices keeps everything, and one Mac no longer replaces the other\u2019s.' },
                { title: 'The iPhone app works when your Mac is away', body: 'Tasks, News and Portfolio are built on the phone when it cannot reach your Mac, and each page says so.' },
                { title: 'A second model for your phone', body: 'Choose nenva Cloud for when your Mac is away, under Settings, AI Assistant, Models. It is off until you choose it, and it names itself under every answer.' },
                { title: 'Approvals on your phone', body: 'When a chat from your phone needs your OK for a step, the question now comes to the phone instead of being declined.' }
            ]
        },
        {
            ...
            date: 'September 25, 2026',
            highlights: [
                { title: 'Search finds calendar events', body: 'Cmd+K finds your calendar events, and so does the assistant. A repeating event shows up once, as its next occurrence.' },
                { title: 'Journal search works again', body: 'Search matched journal entries only by their title or date, not what you wrote. It now finds an entry by its words and opens it.' }
            ]
        },
        {
            ...
            date: 'September 25, 2026',
            highlights: [
                { title: 'Run a routine again from its result', body: 'A routine\u2019s result page has a Run now button beside the routine\u2019s name.' },
                { title: 'No more tool requests posted as results', body: 'A routine that reached its tool limit could post a raw tool request to your feed instead of an answer. It now writes a plain answer, or says it ran out of room.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'The menu bar icon is nenva\u2019s', body: 'With Keep running in the menu bar on, the icon there still showed the old A. It is now the nenva mark, and it follows a light or dark menu bar.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'Everything a calendar event carries', body: 'Event details now show the organizer, who is coming, the call link, reminders and attachments, for Google and Apple calendars alike. The home card has a Join button for calls.' },
                { title: 'Current headlines in Portfolio', body: 'Turn on Current headlines from CNBC under Settings, Portfolio for a short summary of what CNBC is running now, on All Accounts and each ticker page.' },
                { title: 'One switch for Portfolio\u2019s AI writing', body: 'Settings, Portfolio, Generate stock profile using AI turns the stock profiles and the daily brief off together.' },
                { title: 'The routine opens in place', body: 'Opening the routine behind a home feed post used to put it underneath the response. It now takes the page, and Back to the result returns you where you were.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'Your files moved to the nenva folder', body: 'Notes, Journal, Documents and your own apps now live in the nenva folder in your home folder. The app moved the Anjadhe folder there once, without copying or deleting anything, and left an Anjadhe link behind so anything pointing at the old folder keeps working.' },
                { title: 'Model names say nenva Cloud', body: 'A cloud model added before the rename kept its old name. It now reads nenva Cloud.' }
            ]
        },
        {
            ...
            date: 'September 22, 2026',
            highlights: [
                { title: 'Anjadhe is now nenva', body: 'Same app, same company, a new name. Everything you see says nenva now, and nothing about how it works has changed: your data, license, accounts, paired phone and sync carry on as they were.' },
                { title: 'A new icon', body: 'A white lowercase n with a leaf growing from it, on the same dark tile.' },
                { title: 'The app keeps its old name in Applications', body: 'Updates replace the app in place, so in Applications and Finder it is still called Anjadhe until you rename it. Nothing depends on the name. Your files also stay in the Anjadhe folder, so nothing that points at them breaks.' },
                { title: 'Earlier releases open on GitHub', body: 'The website moved to nenva.co and its changelog page is gone, so the full list of releases now opens on GitHub.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'Portfolio and News on your phone, in full', body: 'The paired iPhone app shows the real apps now: accounts and scopes, every ticker with its indicators and business profile, your strategy and daily brief, and in News the rail, Catch me up, topics and the reader. Every number is still worked out on your Mac.' },
                { title: 'Replies arrive as they are written', body: 'Asking your Mac something from the phone used to sit silent until the whole answer was ready. It now streams in as it comes.' },
                { title: 'Contact the founder works again', body: 'In What\u2019s new it handed a mailto to macOS, which opens nothing if you have no mail client set up. It now opens the founder page on the site.' }
            ]
        },
        {
            ...
            date: 'September 21, 2026',
            highlights: [
                { title: 'An old note and a current one are no longer the same', body: 'When the assistant reads your notes it now sees when each was last changed, so two notes that disagree get the newer answer first and the older one named, rather than whichever turned up.' },
                { title: 'The workroom preview stops inventing', body: 'A long job used to shorten what it had read down to nothing and then fill the gap: one calendar run wrote up two meetings that do not exist. What it keeps is now whole, and what it drops says so. New Notes and Planner agents, and watching its browser no longer pauses the work. Still off by default under Developer settings.' }
            ]
        },
        {
            ...
            date: 'September 21, 2026',
            highlights: [
                { title: 'Simple home is how Anjadhe opens', body: 'One place to type, with Needs you under it and Ongoing work folded beneath. The cards you knew are a click away under Widgets. Same data, same permissions, same models — Settings then Appearance then Simple home turns it off.' },
                { title: 'What your routines said, on the front page', body: 'One row per routine with something unread: its name, its headline, when it ran. A routine that stopped to ask you something appears in Needs you instead.' },
                { title: 'Links open in your own browser', body: 'The built-in Web Browser is gone. Every link you follow now opens in the browser you already use, signed in as you. Reading and summarising a page on your Mac is unchanged.' },
                { title: 'Bookmarks is its own app', body: 'It used to live behind the Web Browser\'s new tab page. Same links, tags and groups, now with its own place in the sidebar.' },
                { title: 'Faster syncing with your phone away from home', body: 'The Mac now dials the relay alongside a direct connection instead of after it. At home the direct connection still wins and nothing goes through the relay.' },
                { title: 'Inbox drops Needs reply and Waiting on them', body: 'The thread labels did not work well enough to keep. Everything else about Inbox and Insights is unchanged, and bundles now start off.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'A routine can stay quiet', body: 'A run that finds nothing worth telling you now posts nothing, and still counts as a run that worked. The routine page marks it quiet, and five quiet runs in a row say so and point at the prompt.' },
                { title: 'Try it before you arm it', body: 'A new routine has no Create button until you have run its prompt once in front of you. The preview posts nothing and creates nothing, and What should be different? rewrites the instruction.' },
                { title: 'Which model answers what', body: 'With two or more models, Settings then AI Assistant then Models can send one part of the app somewhere else: email, news, documents, portfolio, routines, or small jobs. Chat follows the model marked Default.' },
                { title: 'Change a routine by talking to it', body: 'Quoted asks under the prompt (make it weekly, make it shorter, let it search the web), and the approval dialog shows the edit as from and to for the fields that change.' },
                { title: 'Your routines day, in one line', body: 'Home opens with what your routines did today, one row each, every row a door to that edition. A routine nobody opens offers to go weekly or to be deleted.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'See what your AI makes of every ticker at once', body: 'Portfolio › Tickers has a new Indicators view: each ticker wearing the one-word verdicts from its daily business profile — valuation, soundness, AI role, risk, value, news — with a sortable column each. Click a column to bring the best ones to the top.' },
                { title: 'Quieter ticker lists', body: 'The coloured letter tile in front of each symbol is gone; it only ever repeated the symbol beside it.' },
                { title: 'The same back button everywhere', body: 'Backing out of an email now looks like backing out of an insight or a news article.' }
            ]
        },
        {
            ...
            date: 'September 15, 2026',
            highlights: [
                { title: 'Routine drafts are kept', body: 'If you leave the page while writing a routine, what you typed is still there when you come back, even after a restart. Nothing is scheduled until you click Create routine.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'Private chats', body: 'Click Private in the AI Assistant header for a chat that is not saved to your history and that the assistant will not remember. A checkbox on the chat decides whether it can use your personal info. It ends when you leave it.' },
                { title: 'Shopping in your own browser', body: 'With Use other apps turned on, asking for something on your accounts, like adding to your cart or signing in, now happens in your own signed-in browser. Browser screenshots also reach the AI now, so it can see the page.' }
            ]
        },
        {
            ...
            date: 'September 13, 2026',
            highlights: [
                { title: 'The assistant can use the app', body: 'Ask what you are looking at, or ask it to do something in Anjadhe itself. It looks at the window and works one step at a time, asking before each action.' },
                { title: 'Try it in your other apps', body: 'An experimental switch, Settings › Developer › Experimental features › Use other apps, lets the assistant work in your browser and other apps. It asks before a new website and before buying, sending or deleting.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'Where the story continues', body: 'A news summary now ends with a few real links to related coverage — another outlet on the same story, background, what followed. The headlines and links are the publishers\' own; the AI only picks which are worth your time.' },
                { title: 'Read one news source at a time', body: 'With more than one source turned on, the News rail lists them: click Hacker News to see only its stories, All sources to come back. It lasts for the session, not forever.' }
            ]
        },
        {
            ...
            date: 'September 12, 2026',
            highlights: [
                { title: 'A quieter sidebar', body: 'The left sidebar sits on the page instead of on a white column, with plain icons and a bar marking the app you are in. White is for the things you read.' },
                { title: 'Projects uses the width', body: 'The table now starts at the left edge of the page heading, and a project\'s group has its own column instead of a pill under the title. Clicking the group still filters to it.' },
                { title: 'The assistant\'s help is current', body: 'Ask how something works and it names Cloud Privacy, Contacts and More apps by their real labels, talks about project updates, and speaks to you directly.' },
                { title: 'Local AI, by the size of your Mac', body: 'Any Mac with 8 GB or more runs the AI on the machine: a small model tuned by Anjadhe on 8 to 16 GB, larger ones from 32 GB up.' },
            ],
        },
        {
            ...
            highlights: [
                { title: 'A new look, matching the website', body: 'The app wears the same theme as anjadhe.ai: system text, serif headings, a compact type scale, white panels on an off-white ground, pill buttons, and one blue for what is live. What you read sits on a white sheet at one prose size. The app icon is a white serif A on a near-black tile.' },
                { title: 'Projects open on one table', body: 'Every active project in one table with progress, next step, last update and target. A Needs attention list above it names what wants you; completed projects fold beneath. Group pills filter the table and each group keeps its colour.' },
                { title: 'Updates: a log on every project and task', body: 'Post what happened, and the assistant posts there too when you ask how a project is going, press Ask Anjadhe to check in, or a weekly review runs. Each entry says who posted it and when.' },
                { title: 'Portfolio: Tickers page and verdict tiles', body: 'A Tickers section in the left nav puts every symbol you hold or follow on one sortable table. A ticker profile now ends in verdicts (valuation, soundness, AI role, risk, value, news tone) shown as tiles above the prose.' },
                { title: 'Share a Portfolio account (experimental)', body: 'Pair with another Anjadhe user by invite code under Settings › Accounts › Contacts and share one account read-only, end to end encrypted through Anjadhe\'s relay. Both Macs must be online for now. Turn on Sharing under Settings › Developer › Experimental features.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'Choose where your news comes from', body: 'The News app\'s Topics page has a Sources card: Google News is on by default, and you can add Bing News or Hacker News. Every topic is fetched from each source you turn on and the stories share one timeline. A story from another source says so in its byline.' },
                { title: 'Hacker News stories bring their thread', body: 'A Hacker News story shows its points, and the reader offers a Discussion link to the thread beside the article.' }
            ]
        },
        {
            ...
            date: 'September 10, 2026',
            highlights: [
                { title: 'The assistant can send texts', body: 'Ask it to text someone, or to text you, and it sends through the Messages app on this Mac once an iMessage card in Settings › Accounts is set up. You see the recipient and the exact words first; texts to other people ask every time.' },
                { title: '"Send a message" asks text or email', body: 'When texts are set up and you do not name a channel, the assistant asks which you mean instead of assuming email. It also no longer loses its email tools when your message does not contain the word "email".' },
                { title: 'Texts: the first read covers 30 days', body: 'Insights from your texts starts with the last 30 days instead of 3. If you already turned it on, flip the switch off and on to get the wider window; tasks stay.' },
                { title: 'Full Disk Access, spelled out', body: 'macOS does not list Anjadhe under Full Disk Access by itself. The card and the error now say to click +, choose Anjadhe from Applications, then quit and reopen the app.' }
            ]
        },
        {
            ...
            date: 'September 10, 2026',
            highlights: [
                { title: 'Insights from your texts', body: 'Turn on Settings › Accounts › iMessage › Insights from your texts and the texts that arrive in Messages on this Mac are read like your mail: appointments, deliveries, bills, codes and plans made over text land in the same folders, and what needs doing becomes a task. Off until you turn it on; it needs Full Disk Access (add Anjadhe with the + button in System Settings › Privacy & Security › Full Disk Access, then reopen the app), and your texts go only to the model you chose.' },
                { title: 'Email AI is now Insights', body: 'Same page, same folders. The name changed because it holds what your mail and your texts said. The home card is now "Needs a look".' },
                { title: 'Focus mode', body: 'While a Pomodoro focus phase runs, a titlebar pill shows the task and time left, the left nav folds, and email, text and routine notices wait until the phase ends. Reminders always come through.' },
                { title: 'One save indicator', body: 'The task sheet, project sheet, Notes and Journal share one Unsaved / Saved indicator, and leaving a page saves what you typed. A blank title or a task that cannot be saved gets a warning with a way to fix it.' },
                { title: 'One task sheet everywhere', body: 'Tasks, Projects, Calendar and Insights all open the same task card, with a breadcrumb naming where you came from. Projects, More apps, About, the Notes rail and Settings joined the same look.' },
                { title: 'A new app icon', body: 'A bold rounded A with one indigo dot on a deep charcoal tile.' }
            ]
        },
        {
            ...
            date: 'September 10, 2026',
            highlights: [
                { title: 'Documents, redesigned', body: 'The list is one card with a bar showing what kinds of files a tag holds, every row leads with a file-type tile, tags carry a colour per family, and the reader opens with a proper title, pill buttons and the AI tidy banner as a card.' },
                { title: 'Monochrome icons in News', body: 'Publisher tiles, the Catch-me-up sparkle and event date tiles are black and white again. Topic colours stay on the dots and chips.' },
                { title: 'A cleaner first-run setup', body: 'Each setup step now sits in one card with its buttons in a footer and the step indicator above it.' },
                { title: 'Terminal access moved to Experimental features', body: 'The anjadhe command and its Settings page are off by default now. Turn on Terminal access under Settings › Developer › Experimental features to get them back; your earlier setting is kept.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'Home opens instantly again', body: 'Coming back to Home could block the app for half a second or more when you had many notes and routine results. It now paints at once, whatever is in the feed.' },
                { title: 'Suggested prompts are written for you', body: 'The "Try asking" pills on Home and in the assistant now come from your own tasks, projects, calendar, email and notes, refreshed about once an hour. Only data you allow to leave the Mac is used.' },
                { title: 'A touch of colour', body: 'Inbox, Email AI, Routines, News and Calendar use one subtle hue per insight type, sender, routine or topic so you can tell things apart before reading. Text and chrome stay black and white.' },
                { title: 'Calendar Sync refreshes Apple and Google', body: 'The Sync button now updates both sources, and shows whenever either is connected. Apple events also stop blinking out after a Google sync.' },
                { title: 'Today is one list', body: 'On the Tasks page, timed tasks come first in clock order, then the untimed ones after a hairline. The separate "Anytime" card is gone.' },
                { title: 'Long web searches still end in an answer', body: 'When the assistant searches too many times in one turn, it stops searching and writes from what it found instead of quitting with a canned message.' }
            ]
        },
        {
            ...
            date: 'September 9, 2026',
            highlights: [
                { title: 'Change Apple Calendar events from Anjadhe', body: 'Add events to your iCloud or local calendars, and edit or delete Apple events, straight from the Calendar page or by asking the assistant. Every change is written to Apple Calendar and read right back.' },
                { title: 'Apple Calendar catches up when you return', body: 'Coming back to Anjadhe from Calendar.app refreshes the grid at once.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'Connecting Google is one step shorter', body: 'Google has approved Anjadhe, so the "unverified app" warning no longer appears. Connect Google now opens the sign-in page directly, without the walkthrough that explained how to get past that screen.' }
            ]
        },
        {
            ...
            date: 'September 8, 2026',
            highlights: [
                { title: 'Apple Calendar asks for permission, for real this time', body: 'The previous fix was not enough: the app itself was refusing calendar and reminder access before macOS could ask. Turning on Apple Calendar or Apple Reminders now shows the consent dialog, and Anjadhe appears under Privacy & Security.' }
            ]
        },
        {
            ...
            date: 'September 8, 2026',
            highlights: [
                { title: 'Apple Calendar refreshes on its own', body: 'Events you add in Calendar.app now show up within a minute while you are on the Calendar, and within five minutes otherwise, instead of at the next launch.' },
                { title: 'See an update downloading', body: 'A small strip in the top-right corner shows the version and progress while a new build downloads, and says so if the download fails.' }
            ]
        },
        {
            ...
            date: 'September 8, 2026',
            highlights: [
                { title: 'Read any article by its link', body: 'Paste a link into the News search box and the reader opens on it; when the page will not load, coverage of the same story from other sources is summarized instead. A small Chrome extension in the source hands the current tab to the app with one click.' },
                { title: 'Portfolio knows your holdings', body: 'Each ticker gets a daily business profile built only from Yahoo Finance figures and headlines, and All Accounts opens with a daily market-and-portfolio brief that describes and never advises. Tell the assistant when a profile has something wrong and it is rewritten around your note.' },
                { title: 'Reach your Mac from anywhere', body: 'With Tailscale on the Mac, a new switch in Settings › Paired Devices lets your phone reach this Mac directly from any network, with nothing installed on the phone.' },
                { title: 'Fuller forwarded notifications', body: 'Reminders sent to Telegram or iMessage now carry the date, description, project and source, not just a time.' },
                { title: 'Apple Calendar asks for permission', body: 'Turning on Apple Calendar or Apple Reminders now shows the macOS consent dialog; before, macOS refused silently and Anjadhe never appeared under Privacy & Security.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'News stays behind Anjadhe Connect', body: 'When Connect cannot fetch headlines, News and Portfolio now say so and keep the last ones they did fetch, instead of fetching from this Mac and showing Google your topics and holdings from your own address. Your own Tavily or Brave key still fetches directly.' }
            ]
        },
        {
            ...
            date: 'September 3, 2026',
            highlights: [
                { title: 'News on holdings is back', body: 'Portfolio ticker and account pages show headlines again. When Anjadhe Connect cannot fetch a topic, the app now fetches it from this Mac instead of showing nothing.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'Documents', body: 'Reader is now Documents: PDFs, scans, spreadsheets, Word and PowerPoint files, web pages and notes, indexed on this Mac and organized with tags drawn as a tree. The assistant can search within a tag and tag a document for you.' },
                { title: 'Writing voice is a setting', body: 'Your voice lives in Settings › Writing voice; ask the assistant to "write this in my voice" when you want it. The Writing Voices app and custom voices are gone.' },
                { title: 'Reading pane on laptops', body: 'Inbox, Email AI, Notes and Journal start with the reading pane hidden on a laptop-sized display, and the first-run welcome in Notes and Journal shows again there.' }
            ]
        },
        {
            ...
            date: 'September 2, 2026',
            highlights: [
                { title: 'A new icon', body: 'Anjadhe now wears a simple white "A" on a dark grey tile. Inside the app the logo appears only on the loading screen.' },
                { title: 'No price quoted yet', body: 'About, Help and Settings › License no longer name a future license price. The plan is unchanged: free during the alpha, and everyone who installs during the alpha keeps the app free for good.' }
            ]
        },
        {
            ...
            highlights: [
                { title: 'A tidier Accounts page', body: 'Google, the Apple apps, Telegram and iMessage now share one card layout in Settings › Accounts: a status line with a colored dot, descriptions that no longer cut off, and one button size throughout.' },
                { title: 'Telegram status stays current', body: 'If a network change interrupts the connection, the card now says "Reconnecting" and clears itself once the bridge is back, instead of showing a stale error.' }
            ]
        },
        {
            ...
            date: 'September 1, 2026',
            highlights: [
                { title: 'Telegram setup, explained', body: 'Ask the assistant how to set up Telegram and it walks you through it: create your bot, connect the token, link your chat with the pairing code. The same guide is on anjadhe.ai/help.' }
            ]
        },
        {
        ...
        },
        {
            ...
            highlights: [
                ...
                { title: 'What Anjadhe will cost', body: 'Free during alpha. A one-time license is planned later, and alpha users keep the app free for good. The Closed Alpha pill in About has the details.' }
            ]
        },
        {
        ...
        },
        {
            ...
            highlights: [
                ...
                { title: 'Anjadhe Cloud, checkable', body: 'The Anjadhe Cloud card states its commitments in checkable sentences, names its inference provider\'s terms, and shows the commit the server is running so you can compare it with the public code.' },
    ...
    open() {
        ...
        const modal = Modal.create({
            title: 'What&rsquo;s new in nenva',
        ...
        modal.body.querySelector('.whats-new-contact-link')?.addEventListener('click', (e) => {
            e.preventDefault();
            window.electronAuth?.openExternal?.(this.FOUNDER_PAGE);
        });
    },
    ...
    async openChangelog() {
        ...
        modal.body.innerHTML = html + `
            <p class="whats-new-foot">
                <a href="#" class="whats-new-changelog-link">See every release on GitHub</a> &middot;
                <a href="#" class="whats-new-contact-link">Contact the founder</a>
            </p>`;
        modal.body.querySelector('.whats-new-changelog-link')?.addEventListener('click', (e) => {
            e.preventDefault();
    ...
    async openReleaseNotes(version) {
        ...
        modal.body.innerHTML = html + `
            <p class="whats-new-foot">
                <a href="#" class="whats-new-changelog-link">See every release on GitHub</a>
            </p>`;
        modal.body.querySelector('.whats-new-changelog-link')?.addEventListener('click', (e) => {
            e.preventDefault();
