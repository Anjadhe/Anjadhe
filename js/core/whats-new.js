...
const WhatsNew = {
    ...
    FOUNDER_MAILTO: 'mailto:anjadhe.ever@gmail.com?subject=Anjadhe%20feedback',
    ...
    async openChangelog() {
        ...
        try {
            ...
            if (res.ok) {
                ...
                if (Array.isArray(data?.releases) && data.releases.length) releases = data.releases;
            }
        } catch { /* offline or blocked: fall back below */ }
