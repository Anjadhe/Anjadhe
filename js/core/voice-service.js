...
const VoiceService = {
    ...
    // for task-grade brains (2026-08-10, Ram: the supported brains were
    // then ≥32GB local, a user-hosted server, or BYOK; since 2026-08-26
    // 8–16 GB Macs run anjadhe-qwen3.5:4b or nenva Cloud, and Light is
    // the depth for that tier — not a floor to design around). The setting is PER-MAC
...
JSON object:`;
     ...
     * (nenva Connect's proxy whitelist drops it; a fine-tuned GGUF's
