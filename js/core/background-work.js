...
const BackgroundWork = {
    ...
    _sources: [
        ...
        // Today's market-and-portfolio brief (one call). Resumable: a run
        // cut off by a reload is simply asked for again on the next visit.
        () => {
            if (typeof PortfolioBrief === 'undefined' || !PortfolioBrief.writing()) return null;
            return { id: 'portfolio-brief', label: 'Writing today’s portfolio brief', resumable: true };
        },
