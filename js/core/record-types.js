 ...
 *   decisions   false → not a decision host; default true (ticker became one 2026-09-03)
 *
...
(function seedBuiltins() {
    ...
    RecordTypes.register('goal', {
        label: 'Project', plural: 'projects', words: ['project', 'projects', 'goal', 'goals'], app: 'goals',
        ...
        resolve: ({ id }) => byId('goals', 'goals', id, 'project'),
