...
const AppManager = {
    ...
    setupScheduleNotifications() {
        ...
        const checkAndNotify = () => {
            // Telegram forwarding is a second delivery lane: a denied macOS
            // permission must not silence reminders headed for the phone.
            if (Notification.permission !== 'granted'
                && !(typeof Notify !== 'undefined' && Notify.telegramActive())) return;
