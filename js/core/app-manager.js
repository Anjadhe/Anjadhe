...
const AppManager = {
    ...
    openApp(appName, updateHash = true) {
        ...
        if (appView) {
            ...
            // First visit to a feature page: show its contextual help once.
            // The "?" in the page header brings it back any time.
            if (typeof ContextHelp !== 'undefined') {
                ContextHelp.maybeAutoShow(appName);
            }
        }
    },
