...
const AppManager = {
    ...
    _showAnalyticsOptInNudge() {
        ...
        content.innerHTML = `
            <p class="analytics-ask-lead">
                Anjadhe has no accounts and no server watching you work. That is
                ...
                never use Anjadhe Connect, this Mac has never said a word to me.
            </p>
    ...
    showSetup() {
        ...
        const addDefaultBrain = async () => {
            try {
                ...
                const label = (first && first.label) || 'Anjadhe Cloud';
                ...
                console.warn('[setup] default Anjadhe Cloud entry failed:', err);
            }
        };
     ...
     */
    // ── Opening a link ────────────────────────────────────────────────
    // Anjadhe has no browser of its own (the Web Browser app was removed
    ...
    _settingsCategoryForApp: {
        agent: 'ai',
        calendar: 'accounts',
        // Portfolio and Spending configure one thing, the Linked
        // institutions card, which lives on the Accounts panel.
        portfolio: 'accounts',
        spending: 'accounts',
    ...
    _settingsAnchorForApp: {
        portfolio: { head: 'settings-brokerages-head', card: 'settings-brokerages-group' },
