...
const AppManager = {
    ...
    showSetup() {
        ...
        const goToStep2 = async () => {
            ...
            // Stepper (2026-09-09): steps behind the current one read as done.
            for (const id of ['setup-step-ind-1', 'setup-step-ind-2', 'setup-step-ind-name']) document.getElementById(id).classList.remove('done');
            setBack(goToStep1);
        ...
        const goToStep3 = () => {
            ...
            document.getElementById('setup-step-ind-name').classList.remove('active');
            document.getElementById('setup-step-ind-1').classList.add('done');
    ...
    handleDeepLink(link) {
        ...
        // rather than opening the page in Browse, which is not what the
        // extension promised.
