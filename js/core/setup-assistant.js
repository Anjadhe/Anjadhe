...
const SetupAssistant = {
    ...
    steps() {
        const list = [
            {
                ...
                desc: 'One Google sign-in links Gmail and Calendar. nenva then reads your important emails on your Mac and turns things you need to do into tasks — automatically. Optional, and you can disconnect anytime.',
                cta: 'Connect Google',
            ...
            },
            {
                ...
                desc: 'Start with a tour — ask what nenva can do and what to try first. Once email and calendar are in, it can plan your week around them too.',
                cta: 'Try it',
        ...
        if (typeof LicenseClaim !== 'undefined' && LicenseClaim.stepApplies()) {
            list.push({
                ...
                desc: 'Alpha users keep nenva free for good. Claiming puts that on record with a small signed key saved on this Mac; it asks for an email only so the same key can be issued to you again.',
                cta: 'Claim',
                done: false,
            ...
            setTimeout(() => {
                try {
                    ...
                    if (input) {
                        ...
                        input.value = 'What can you do? Give me a quick tour of nenva and a few things worth trying first.';
                        input.focus();
                    }
                } catch {}
            }, 200);
    ...
    renderCompact(container) {
        ...
        strip.innerHTML =
            `<span class="setup-assistant-strip-text">Set up more of nenva &mdash; ${done} of ${total} done</span>`;
...
// what nenva can do (agent-ui empty state). The checklist remains on
