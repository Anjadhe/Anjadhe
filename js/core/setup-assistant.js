...
const SetupAssistant = {
    ...
    _searchConfigured: null,   // latest known: is any provider active?
    ...
    _refreshSearchStatus() {
        ...
        (async () => {
            try {
                ...
                const changed = configured !== this._searchConfigured;
                this._searchConfigured = configured;
                if (changed) this._rerender();
            } catch { /* stays unknown — shows as not done */ }
    ...
    steps() {
        ...
        list.splice(1, 0, {
            ...
            done: this._searchConfigured === true,
