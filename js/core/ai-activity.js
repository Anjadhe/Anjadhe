 ...
 * that bypass LLMLogger (Maker, task mode, model warm-up). This
...
const AIActivity = {
    ...
    TAG_INFO: {
        ...
        'actions-filing':       { label: 'Actions suggestions', desc: 'Suggesting a goal or date for unfiled tasks — chips you confirm', auto: true },
