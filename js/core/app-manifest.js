...
const AppManifest = {
    ...
    validate(raw, { bundled = false } = {}) {
        ...
        if (bundled) {
            ...
            // A package may contribute MORE THAN ONE app (Reader carried
            // Writing Voices this way until 2026-09-02; nothing uses it
            // today): each extra gets its own registry tile + label; its
            // view div rides the package's view fragment and its scripts
            // register it like the primary.
