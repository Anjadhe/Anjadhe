 ...
 *
 * Sends what the user wrote to nenva Connect (POST /v1/feedback), under
...
const FeedbackManager = {
    ...
    async collectDiagnostics() {
        ...
        // that is the only form nenva stores; the raw form travels in
    ...
    async send({ kind, message, email, includeDetails = true } = {}) {
        ...
        try {
            ...
            return { success: false, error: 'Could not reach nenva. Check your connection and try again.' };
        }
    }
};
