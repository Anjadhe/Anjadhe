...
const CloudPrivacy = {
    ...
    CLASSES: [
        ...
        { id: 'messages',  label: 'Messages',       desc: 'iMessage and SMS conversations read for insights (Settings › Accounts › iMessage). Off by default.', off: true },
        ...
        { id: 'spending',  label: 'Spending',       desc: 'Bank and card transactions and balances. Off by default.', off: true },
        { id: 'browse',    label: 'Web pages',      desc: 'The text of pages a routine reads with read_url.' },
        { id: 'files',     label: 'Files',          desc: 'Files a routine reads from your Anjadhe folder.' }
    ],
    ...
    SOURCE_CLASS: {
        ...
        // Noticing (docs/NOTICING.md N8): the pass reads journal entries, so
        // it rides the journal class — which is OFF by default, meaning a
        // cloud brain cannot notice anything until the user says otherwise.
        'noticing': 'journal'
    },
    ...
    TOOL_CLASS: {
        ...
        // list_journal / get_journal_entry: registered by the Journal package (dataClass).
