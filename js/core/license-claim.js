    ...
    openModal({ source = 'unknown' } = {}) {
        ...
        content.innerHTML = `
            <p style="margin: 0 0 var(--space-md); line-height: 1.6;">
                Everyone who installs during the alpha keeps nenva free for good.
        ...
        const claim = async () => {
            ...
            modal.close();
            UIUtils.showToast(r.created ? 'Alpha license claimed. nenva is yours, free for good.' : 'Welcome back — your alpha license is restored.', 'success');
            await this.refresh();
