...
function _guestMain() {
    ...
    // The global nenva object app.js references, plus shims for the few host
...
const UserAppSandbox = {
    ...
    _buildGuestHtml(manifest, entry) {
        ...
        // No webfont link. The host loads no web font either (2026-09-11: the
        // design system is the system sans + the OS serif stack, so the guest
        // renders in exactly the host's faces). The old fix was a
        // fonts.googleapis.com <link>, which meant every user-app render made
        // its own request to Google — don't bring one back.
