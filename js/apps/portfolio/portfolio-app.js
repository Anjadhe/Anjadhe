    ...
    AgentContext.register('portfolio', () => {
        ...
        if (PortfolioApp.viewingTicker) {
            ...
            return {
                ...
                body: `The user is viewing the detail page for ${label}. When they say "this stock" / "this ticker" / "this position", they mean ${label}.${symbolNote} Use get_ticker_detail or list_portfolio if you need current numbers, and get_holdings_news with tickers ["${t}"] for recent headlines about it.`,
                suggestedPrompts: [
        ...
        if (hasData) {
            return {
                ...
                body: 'The user is viewing their portfolio overview (all accounts, holdings, cash, real estate). Use list_portfolio for current holdings, totals, and cash; get_ticker_detail for a single stock; get_holdings_news for recent headlines on the holdings. Ground observations in tool numbers.',
                suggestedPrompts: [
