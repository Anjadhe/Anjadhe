/**
 * PortfolioSharing — one account, read-only, on another nenva user's Mac.
 * ========================================================================
...
const PortfolioSharing = {
    ...
    async showShareModal(accountId) {
        ...
        if (!this._contacts.length) {
            const go = await UIUtils.confirm('No contacts yet', 'Sharing goes to a contact — another nenva user you have paired with by invite code. Add one in Settings › Accounts › Contacts first.', '', { confirmText: 'Open Settings' });
