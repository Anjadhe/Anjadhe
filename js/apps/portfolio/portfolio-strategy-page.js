...
const PortfolioStrategyPage = {
     ...
     */
    _disclaimer() {
        return '<p class="strategy-disclaimer">Anjadhe is not an investment adviser. Strategy checks and reviews are information for your own decisions, not investment advice.</p>';
    },
