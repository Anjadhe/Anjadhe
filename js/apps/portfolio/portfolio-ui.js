...
const PortfolioUI = {
    ...
    renderNav(scope) {
        ...
        nav.innerHTML = `
            ...
            ${(typeof PortfolioBrokerage !== 'undefined' && PortfolioBrokerage.available()) ? '<button type="button" class="portfolio-nav-item portfolio-nav-new" data-link-brokerage title="Connect Fidelity, Robinhood, Schwab and others through Anjadhe Cloud">+ Link brokerage</button>' : ''}
            ${sharedHtml}
                ...
                ${transactions.map(txn => {
                    ...
                    return `
                        <div class="portfolio-txn-item" data-txn-id="${txn.id}">
                            <div class="portfolio-txn-left">
                                ${opts.hideTicker ? '' : this.tickerMono(txn.ticker)}
    ...
    renderCashRow(cash, totalValue) {
        ...
        return `
            <tr class="portfolio-cash-row portfolio-row" data-cash="true">
                <td class="portfolio-ticker"><span class="portfolio-ticker-cell">${this.tickerMono('', { cash: true })}<span class="portfolio-ticker-main"><span class="portfolio-ticker-sym">Cash</span><span class="portfolio-ticker-name">Uninvested</span></span></span></td>
                <td class="num">—</td>
                <td class="num">—</td>
                <td class="num">—</td>
                    ...
                    <tbody>
                        ${items.map(w => {
                            ...
                            <tr class="portfolio-row portfolio-watchlist-row" data-ticker="${esc(w.ticker)}">
                                <td class="portfolio-ticker"><span class="portfolio-ticker-cell">${this.tickerMono(w.ticker)}<span class="portfolio-ticker-main"><span class="portfolio-ticker-sym">${esc(w.ticker)}</span>${this.tickerName(w.ticker) ? `<span class="portfolio-ticker-name">${esc(this.tickerName(w.ticker))}</span>` : ''}</span></span></td>
    ...
    /** Monogram tile for a ticker (or 'Cash'). */
