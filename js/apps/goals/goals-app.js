...
const GoalsApp = {
    ...
    setupEventListeners() {
        ...
        // The standalone Goals pages are retired (markup removed) — the
        // list-page controls may not exist. GoalsApp lives on as the data
        // layer for Plan's goal detail.
    ...
    render() {
        // The standalone Goals list page is retired — nothing to paint.
        if (!document.getElementById('goals-view')) return;
