...
const GoalInterview = {
    ...
    _reviewBody(goalTitle) {
        return `Review my project "${goalTitle}". Call list_goals and look at the tasks linked to it: what got done since the last review, what is scheduled next, and how long it has been since anything moved. ` +
