    ...
    renderFilters(notes, currentFilter) {
        ...
        container.innerHTML = `
            <div class="notes-filter-item ${currentFilter === 'all' ? 'active' : ''}" data-filter="all">
                <span class="notes-filter-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></span>
            ...
            ${assistantCount > 0 ? `
                <div class="notes-filter-item ${currentFilter === 'assistant' ? 'active' : ''}" data-filter="assistant">
                    <span class="notes-filter-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 4l1.7 4.8L18.5 10.5l-4.8 1.7L12 17l-1.7-4.8L5.5 10.5l4.8-1.7z"/><path d="M18.5 15.5l.8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8z"/></svg></span>
            ...
            ${pinnedCount > 0 ? `
                <div class="notes-filter-item ${currentFilter === 'pinned' ? 'active' : ''}" data-filter="pinned">
                    <span class="notes-filter-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M9 4h6l-.6 6.2 2.6 2.3v1.5H7v-1.5l2.6-2.3z"/><line x1="12" y1="14" x2="12" y2="21"/></svg></span>
        ...
        container.innerHTML = shownTags.map(tag => {
            ...
            <div class="notes-filter-item notes-tag-filter-row ${currentFilter === tag.name ? 'active' : ''}" data-filter="${safeName}" data-tag-id="${tag.id}">
                ...
                <div class="notes-tag-actions">
                    <button class="notes-tag-action" data-tag-action="edit" data-tag-id="${tag.id}" title="Rename tag" aria-label="Rename tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></button>
                    <button class="notes-tag-action" data-tag-action="delete" data-tag-id="${tag.id}" title="Delete tag" aria-label="Delete tag"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
                </div>
            </div>
        `;
