...
const NotePrompts = {
    ...
    config(note) {
        ...
        return {
            ...
            // (js/apps/prompts/routine-about.js). A routine had no
            // reference to any record before this, so the two review kinds
            // faked one with their TITLE — that convention still resolves
            // for routines written before the field, and a real id always
            // wins over it.
    ...
    // 2026-09-20), so a bare URL goes straight there and anything else is
    // handed to DuckDuckGo — what the app's address bar did with it.
