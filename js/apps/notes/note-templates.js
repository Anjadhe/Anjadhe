...
const NoteTemplates = {
    DEFINITIONS: {
        ...
        prompt: {
            ...
            label: 'Saved prompt',
            icon: '&#9889;', // ⚡ high voltage
            description: 'A reusable prompt you run yourself, in the AI Assistant or as a web search. Schedule it and it becomes a routine.',
            // A prompt is freeform text like a blank note — its body IS the
            // prompt. Config (run target, offline schedule, web search) lives
            // on `note.prompt`. Saved prompts are created and edited here in
            // Notes (pickable template since 2026-07-31); scheduling one
            // turns it into a routine, which lives on the Routines page
            // (PromptsApp) instead.
            seed: () => ({ content: '' })
        },
        assistant: {
        ...
        feed: {
            ...
            label: 'Prompt Feed',
            icon: '&#128240;', // newspaper
            description: 'Output of a routine run, posted to the Home feed.',
