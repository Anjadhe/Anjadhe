 ...
 * button), and the cross-app API other packages act through —
 * Anjadhe.expose('bookmarks') — so any caller's save and
...
(function registerBookmarksPackage() {
    ...
    // One-time fold of the removed Web Browser's own bookmark list into the
    ...
    // ── Cross-app API (Anjadhe.use('bookmarks')) — save + list ──
