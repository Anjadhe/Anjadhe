    ...
    _enableHtml() {
        ...
        return `
            <div class="settings-card voice-enable">
                ...
                <p class="settings-card-hint">Turn this on and nenva studies your own writing — then, when you ask for a draft "in my voice", it sounds like you rather than like an AI. Pick what it may learn from. Nothing is read until you press Study, and the study runs on the AI model you chose.</p>
