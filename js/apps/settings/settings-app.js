...
const SettingsApp = {
    ...
    _renderAccountRow(account) {
        ...
        return this._acct({
            ...
            tone: 'ok',
            rows: [
                { label: 'Mail', value: 'Inbox, Email AI, and tasks found in mail', action: this._renderServiceToggle(account.email, 'mail', services.mail) },
    ...
    async _renderIMessage() {
        ...
        container.innerHTML = this._acct({
            ...
            desc: 'Send this Mac’s reminders and alerts to your own iMessage through the Messages app on this Mac — a text from you to you, so it reaches your iPhone and Watch with Apple’s end-to-end encryption and no bot or server in between. Messages here must be signed in to iMessage; the first send asks macOS for permission to control Messages. Outbound only: the assistant does not read your iMessages.',
    ...
    _renderAppleImport() {
        ...
        container.innerHTML = this._acct({
            ...
            desc: 'Import this Mac’s Apple Notes into Notes, tagged “apple-notes”. Read-only; locked notes are skipped; turning this off removes the imported copies. Turn this on for ONE Mac only — imported notes reach your other Macs through Anjadhe’s own sync.',
