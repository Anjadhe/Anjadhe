...
const SettingsApp = {
    ...
    _renderAnjadheManage(body, entry) {
        ...
        desc.textContent = 'An open-weight model served by Anjadhe Connect (api.anjadhe.com). '
            ...
            + 'which forwards it to DeepInfra (deepinfra.com) under a no-retention agreement, without '
    ...
    _renderAddAnjadheStep(body, ctx) {
        ...
        desc.textContent = 'Open-weight models served by Anjadhe Connect (api.anjadhe.com). '
            ...
            + 'which forwards it to DeepInfra (deepinfra.com) under a no-retention agreement, without your '
    ...
    openPrivacySettings() {
        ...
        if (!this._privacySettingsBound) {
            ...
            this._bindBtn('settings-clear-browse-data-btn', async () => {
                ...
                const confirmed = await UIUtils.confirm(
                    'Clear browse data?',
                    'This wipes cookies, cache, local storage, and saved auth from every site you\'ve visited in the Browse sub-app. Your notes, journal, projects, and other Anjadhe data are not affected.',
                    'Clear'
                );
                if (!confirmed) return;
