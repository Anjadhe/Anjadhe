...
const SettingsApp = {
    ...
    _imessageInsightsCardHtml() {
        ...
        const fdaHint = st.enabled && st.lastErrorReason === 'fda'
            ? 'Grant it, relaunch Anjadhe, then press Check again.' : '';
        return this._acct({
