...
const SettingsApp = {
    ...
    _renderAppleImport() {
        ...
        // Calendar → Calendar: a read-only mirror of iCloud/local calendars
        ...
        container.innerHTML = this._acct({
            ...
            desc: 'Show this Mac’s iCloud and local calendar events in Calendar. Read-only — they can’t be edited here, and turning this off removes them from the view. Google calendars are left out: Anjadhe syncs Google itself.',
