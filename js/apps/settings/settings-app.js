...
const SettingsApp = {
    ...
    _renderAppleImport() {
        ...
        container.innerHTML = this._acct({
            ...
            desc: 'Show this Mac’s iCloud and local calendar events in Calendar, kept current automatically: refreshed every minute while Calendar is open, every five minutes otherwise. Read-only — they can’t be edited here, and turning this off removes them from the view. Google calendars are left out: Anjadhe syncs Google itself.',
