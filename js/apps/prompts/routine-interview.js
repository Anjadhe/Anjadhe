    ...
    INTERVIEW: [
        {
            ...
            examples: [
                ...
                'Weekly on Sunday evening, review my projects and what moved',
        ...
        },
        {
            ...
            why: 'A digest grounded in nothing is the model\'s recall. web=true reaches outside (news, jobs, prices); useContext=true reads their own records (portfolio, schedule, projects).',
            hint: 'Usually derivable from the purpose — a news digest needs web, a project review needs context. Confirm rather than ask open-ended. Skip entirely for task mode when the goal implies it.',
            examples: ['Web for headlines', 'My context for the project review', 'Both for the portfolio-vs-news briefing']
        },
        {
            id: 'voice',
            required: false,
            question: 'Should the posts be written in one of your Writing Voices?',
            why: 'A digest\'s posts can carry a Writing Voice (voice: "<name>" on create_routine) — a daily review that speaks in the user\'s own voice, or a motivator in someone else\'s, lands differently than assistant prose. Default is the assistant\'s own voice.',
            hint: 'OFFER, never push — and only when Writing Voices exist (list_routines results and the user\'s words tell you; if unsure, skip). Digest mode only. Skip entirely for task mode or when the user never mentioned voices.',
            examples: ['My voice for the daily review', 'Skip it — the default is fine']
        },
        {
            id: 'review',
            required: true,
