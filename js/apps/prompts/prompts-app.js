            ...
            container.innerHTML = `${this._draftNoteHtml(null, 'list')}
                <div class="prompt-mgr-list prompts-page-list">
                    <div class="prompt-mgr-empty">
                        ...
                        <p class="prompt-mgr-empty-text">No routines yet. A routine is work nenva does on its own &mdash; each<br>morning, or the moment an email or a file arrives. It writes you an<br>answer on your Home feed, or takes the actions and reports back.</p>
