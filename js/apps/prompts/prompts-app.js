    ...
    _renderCrumbs() {
        ...
        if (this._view === 'detail' && note) {
            Breadcrumb.render('prompts-breadcrumb', [
                { label: 'Prompts', action: toList },
                { label: note.title || 'Untitled prompt' }
            ]);
        } else if (this._view === 'form') {
            Breadcrumb.render('prompts-breadcrumb', [
                { label: 'Prompts', action: toList },
                { label: note ? 'Edit prompt' : 'New prompt' }
            ]);
        } else {
            Breadcrumb.render('prompts-breadcrumb', [{ label: 'Prompts' }]);
        }
    },
    ...
    _renderForm(container, note) {
        ...
        container.innerHTML = `
            ...
            <div class="prompt-mgr-form">
                ...
                <div class="prompts-sched-fields" ${cfg.offline ? '' : 'hidden'}>
                    ...
                    <div class="prompt-mgr-time-row" ${['daily', 'weekdays', 'weekly'].includes(cfg.interval) ? '' : 'hidden'}>
        ...
        container.querySelector('.prompt-mgr-save')?.addEventListener('click', () => {
            ...
            const config = {
                ...
                offline,
                interval,
                time: (offline && ['daily', 'weekdays', 'weekly'].includes(interval))
