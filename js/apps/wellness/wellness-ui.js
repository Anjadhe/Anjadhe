...
const WellnessUI = {
            ...
            <div class="wellness-review-row">
                ...
                <span class="wellness-review-actions">
                    ${armed(title)
                        ...
                        : `<button type="button" class="secondary-btn" data-action="${action}">Turn on</button>`}
                </span>
            </div>`;
    ...
    unitsHtml(app) {
        const esc = UIUtils.escapeHtml;
        const labels = { weight: 'Weight', glucose: 'Blood glucose', temperature: 'Temperature', water: 'Water', distance: 'Distance' };
