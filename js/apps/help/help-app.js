        ...
        },
        {
            ...
            body: `
                ...
                <ul class="help-app-list">
                    ...
                    <li><code>~/Anjadhe/apps/CLAUDE.md</code> and <code>AGENTS.md</code> — the full contract for building an app: the manifest format, the <code>nenva</code> SDK (storage, navigation, tools), and worked examples. Both files hold the same instructions; a coding agent reads whichever one it looks for.</li>
