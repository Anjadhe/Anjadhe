...
const HelpApp = {
    ...
    TOPICS: [
        // ── The framework ────────────────────────────────────────────
        {
            ...
            body: `
                <p>Actions has two tabs. <strong>Tasks</strong> is what to do now; <strong>Goals</strong> is where you plan. Tasks opens to <strong>Today</strong> — tasks due today, anything overdue, repeating tasks, action items pulled from email, and today's calendar events. When everything is checked off, it says so — "done for today" is a real, reachable state.</p>
