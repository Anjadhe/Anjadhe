...
const HelpApp = {
    ...
    TOPICS: [
        ...
        },
        {
            ...
            body: `
                <p>Anjadhe can learn how <em>you</em> write and draft in your voice when you ask. It lives in <strong>Settings &rsaquo; Writing voice</strong>: turn it on, pick what it may learn from, press <strong>Study</strong>. There is no separate app and no other people's voices — just yours.</p>
