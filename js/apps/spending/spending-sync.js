 ...
 * through nenva Connect's Plaid service (docs/SPENDING.md).
 *
    ...
    async pickAccounts(item) {
        ...
        return new Promise((resolve) => {
            ...
            const modal = Modal.create({
                ...
                content: `
                    <p class="spending-link-lede">Each account’s transactions from the last two years come in now; new ones arrive when you open Spending, a few times a day, and you can Sync now any time. Everything passes through nenva Cloud on its way here and is not kept there.</p>
