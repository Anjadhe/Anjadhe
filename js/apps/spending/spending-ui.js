...
const SpendingUI = {
    ...
    emptyState(available) {
        return `<div class="spending-empty">
            ...
            <div class="spending-empty-sub">Link a checking account, savings account or credit card and Spending pulls the last two years of transactions, then keeps them current. You sign in on your bank’s own page through Plaid; no bank password reaches nenva. Transactions travel through nenva Cloud on their way to this Mac and are not stored or logged there. The categories are the bank’s and yours — nothing here is written by AI.</div>
            ${available
