...
const NewsApp = {
    ...
    _listHtml() {
        ...
        return `<div class="news-feed">${notice}${digest}${posts}${foot}</div>`;
    },
    ...
    _searchHtml() {
        ...
        let html = `<div class="news-topic">
            <div class="news-topic-head"><h2 class="news-topic-title">Results</h2></div>${linkRow}
    ...
    _topicHtml() {
        ...
        <div class="news-topic"${this._hueStyle(g.topic)}>
            <div class="news-topic-head">
                ...
                <span class="news-topic-sub">${g.rows.length} stor${g.rows.length === 1 ? 'y' : 'ies'} in the last two days</span>
            </div>
            ${g.rows.map((it, ri) => this._rowHtml(it, gi, ri, false, ri === 0)).join('')}
        </div>`;
    },
