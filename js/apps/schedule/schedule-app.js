    ...
    renderEditorLinkedItems(itemId) {
        ...
        html += `<div class="schedule-goal-picker">
            ...
            <div class="schedule-goal-search-wrap${linkedGoal ? ' is-linked' : ''}">
                ${linkedGoal
                    ? `<button class="schedule-goal-link" id="schedule-goal-link" title="Open this goal">${UIUtils.escapeHtml(linkedGoal.title)}</button>`
                    : `<input type="text" id="schedule-goal-search" class="schedule-goal-search" placeholder="Search goals..." value="">`}
                ${linkedGoal ? `<button class="schedule-goal-clear" id="schedule-goal-clear" title="Remove or change this goal">&times;</button>` : ''}
            ...
            ${suggestMeta ? `<div class="schedule-goal-suggest">
                <span class="actions-suggest-chip" title="Assistant suggestion: file under ${UIUtils.escapeHtml(suggestMeta.title)}">
                    ...
                    <button class="actions-suggest-act" id="schedule-suggest-accept" title="File under this goal">&#10003;</button>
