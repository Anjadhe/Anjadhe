...
const ScheduleApp = {
    ...
    setFilter(type, id = null) {
        ...
        // they're grouped — deliberately independent, so e.g. a focus
        // area's "Today" is one click: select the area, stay on Agenda.
        this.render();
    },
    ...
    renderEditorLinkedItems(itemId) {
        ...
        // shows) — accepting links the goal AND its focus area.
    ...
    render() {
        ...
        // (Data writes still happen; Actions/Plan render their own lists.)
    ...
    _buildTaskCrumbs(taskId, taskTitle) {
        ...
        if (focusArea) {
            ...
            if (goalCrumb) {
                crumbs.push({ label: goalCrumb.title, action: () => { AppManager.openApp('focus'); setTimeout(() => FocusApp.selectNode('goal', goalCrumb.itemId), 0); } });
            }
        } else if (goalCrumb) {
