...
const CalendarUI = {
    ...
    renderEventDetail(event) {
        ...
        if (isApple) {
            html += `<div class="event-detail-row"><span class="event-detail-row-label">Calendar</span><span class="event-detail-row-value">${this.escapeHtml(event.appleCalendar || 'Apple Calendar')} &middot; Apple Calendar${appleWritable ? '' : ' (read-only calendar)'}</span></div>`;
        }
