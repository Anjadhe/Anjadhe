...
const READER_ALLOWED_TAGS = [
    ...
    'span', 'div', 'time', 'picture', 'source', 'caption', 'dl', 'dt', 'dd', 'mark', 'small', 'abbr'
];
const READER_ALLOWED_ATTRS = ['href', 'title', 'src', 'alt', 'target', 'rel', 'loading', 'referrerpolicy', 'datetime', 'srcset', 'colspan', 'rowspan'];
...
const MOBILE_VIEWS = new Set(['insights', 'insight', 'news', 'portfolio']);
