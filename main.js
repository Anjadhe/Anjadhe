...
// ---------------------------------------------------------------------------
// Content files (2026-08-26) — Notes and Journal as Markdown in ~/Anjadhe/
...
function getContentFilesRoot() {
    ...
    if (DATA_ROOT) return path.join(DATA_ROOT, 'Anjadhe');
    return path.join(os.homedir(), 'Anjadhe');
}
...
// app's own workspace (apps, exports); the env overrides matter
